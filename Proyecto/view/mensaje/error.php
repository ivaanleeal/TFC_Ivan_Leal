<head>
    ...
    <title>Error Mensaje - TPCSI</title>
...
<body>
    ...
    <section class="botonesOpcciones">
        ...
        <button onclick="location.href='index.php?c=mensaje&a=menuMensajes'">Volver Listado Mensajes</button>
        <button onclick="location.href='index.php?c=usuario&a=logout'" class="cerrar">Cerrar sesión</button>
    </section>

    <div class="error">❌ No se puede eliminar el Mensaje porque tiene datos asociados.</div>