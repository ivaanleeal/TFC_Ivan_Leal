<head>
    ...
    <title>Accion Realizada Clientes - TPCSI</title>
...
<body>
    ...
    <section class="botonesOpcciones">
        ...
        <button onclick="location.href='index.php?c=usuario&a=usuarioIniciado'">Volver al Menú</button>
        <button onclick="location.href='index.php?c=usuario&a=logout'">Cerrar sesión</button>
    </section>

    <div class="bien">✅ Contraseña Actualizada Correctamente.</div>