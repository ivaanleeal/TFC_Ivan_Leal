...
<body>
    ...
    <section class="botonesOpcciones">
        <h1 class="bienvenida">Hola Administrador <?php echo $_SESSION['nombreUsu']; ?> bienvenido de nuevo</h1>
    ...
    <div class="gridTarjetas">
        ...
        <section class="tarjetaAdmin">
            ...
            <button onclick="location.href='index.php?c=reparacion&a=menuReparacion'">Administrar Reparaciones</button>
        </section>
