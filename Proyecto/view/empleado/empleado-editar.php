<head>
    ...
    <title>Editar Empleado - TPCSI</title>
...
<body>
    ...
    <section class="botonesOpcciones">
        <h1 class="bienvenida">Empleado Cliente</h1>
    ...
    <form method="post" action="index.php?c=empleado&a=actualizar" class="formDatos">
        <div class="fromCon">
            <h2 class="bienvenida">Datos del Empleado</h2>

            <label for="dni">DNI</label>
            <input type="text" name="dni" id="dni" class="form-control" required maxlength="9" placeholder="Numero del DNI" readonly value="<?php echo $empleado->getDni(); ?>" />
            <span id="errordni" class="errortexto"></span>
            <br><br>

            <label for="nombre">Nombre</label>
            <input type="text" name="nombre" id="nombre" class="form-control" required placeholder="Nombre completo" value="<?php echo $empleado->getNombre(); ?>" />
            <span id="errornombre" class="errortexto"></span>
            <br><br>

            <label for="apellidos">Apellidos</label>
            <input type="text" name="apellidos" id="apellidos" class="form-control" required placeholder="Apellidos completos" value="<?php echo $empleado->getApellidos(); ?>" />
