<head>
    ...
    <title>Editar Pieza - TPCSI</title>
    <link rel="icon" href="https://yt3.ggpht.com/ssGR_sKs0gRpkLzFhxUig46rmwq73x6PzDsmaQh_Mu6jYG8SRsfSciptLPqMudHZpYQQRfOR=s108-c-k-c0x00ffffff-no-rj" type="image/x-icon">
    <link rel="stylesheet" href="../Estilos/estilos.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <script src="../JS/validarPieza.js" defer></script>
</head>
...
<body>
    ...
    <form method="post" action="index.php?c=pieza&a=actualizar" class="formDatos">
        <div class="fromCon">
            <h2 class="bienvenida">Datos de la Pieza</h2>

            <label for="codigo_pieza">Código Pieza</label>
            <input type="text" name="codigo_pieza" id="codigo_pieza" readonly class="form-control" required maxlength="6" placeholder="AAA123" value="<?php echo $pieza->getCodigoPieza(); ?>" />
            <span id="errorCodigo_pieza" class="errortexto"></span>
            <br><br>

            <label for="nombre">Nombre</label>
            <input type="text" name="nombre" id="nombre" class="form-control" required value="<?php echo $pieza->getNombre(); ?>" placeholder="Nombre Pieza"   />
            <span id="errornombre" class="errortexto"></span>
            <br><br>

            <label for="marca">Marca</label>
            <input type="text" name="marca" id="marca" class="form-control" required placeholder="Asus"  value="<?php echo $pieza->getMarca(); ?>"/>
            <span id="errorMarca" class="errortexto"></span>
            <br><br>

            <label for="modelo">Modelo</label>
            <input type="text" name="modelo" id="modelo" class="form-control" required placeholder="Modelo Pieza"  value="<?php echo $pieza->getModelo(); ?>"/>
